...
$config = [
    ...
    'Users' => [	
		'table' => 'MyUsers',			// Származtatott tábla beállítása

        'Registration' => [
            'active' => true,			// determines if the register is enabled
            'defaultRole' => 'user',	// default role name used in registration
            'ensureActive' => true,		// ensure user is active (confirmed email) to reset his password
        ],
        ...
        'Tos' => [
            'required' => false,		// determines if the user should include tos accepted
        ],
