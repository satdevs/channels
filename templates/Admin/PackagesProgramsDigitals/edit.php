				...
				<?= $this->Form->create($packagesProgramsDigital, ['id' => 'main-form', 'class'=>'form-horizontal']) ?>
					...
					<div class="card-body" style="opacity: 0;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<?php echo $this->Form->control('ackey_id', ['options' => $ackeys, 'class' => 'selectpicker form-control integer', 'title' => 'Kérem válasszon...', 'data-live-search' => 'true', 'data-actions-box' => 'true', 'label' => false, 'empty' => false]); ?>
							</div>										
						</div>
...
*/ ?>
						...
						<div class="form-group row">
							...
							<div class="input-group col-xs-12 col-sm-10 col-md-8 col-lg-4 col-xl-3">
								<?= $this->Form->control('lcn', ['type' => 'number', 'class' => 'form-control number', 'label' => false, 'templates'=>[ 'inputContainer' => '{{content}}', 'inputContainerError' => '{{content}}{{error}}'], "required" => false]) ?>
							</div>
						</div>
<?php /*
						<!-- 6. string -->
...
*/ ?>
						...
						<div class="form-group row">
							...
							<div class="input-group col-xs-12 col-sm-10 col-md-8 col-lg-4 col-xl-3">
								<?= $this->Form->control('qam', ['placeholder' => __(''), 'type'=>'text', 'class'=>'form-control', 'label' => false, 'autofocus' => false, "required" => false]) ?>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="input-group col-xs-12 col-sm-10 col-md-8 col-lg-4 col-xl-3">
								<?= $this->Form->control('sid', ['type' => 'number', 'class' => 'form-control number', 'label' => false, 'templates'=>[ 'inputContainer' => '{{content}}', 'inputContainerError' => '{{content}}{{error}}'], "required" => false]) ?>
							</div>
						</div>
