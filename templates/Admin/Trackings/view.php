<?php // Baked at 2021.11.10. 07:45:01  ?>
<?php
/**
...
?>
		<div class="view col-sm-10 trackings">
			<div class="card card-lightblue">
				<div class="card-header">
					<h3 class="card-title"><?= $title ?>: <?= h($tracking->name) ?></h3>
				</div><!-- /.card-header -->
				<div class="card-body">
					...
					<div class="form-group row"><!-- 1. -->
						...
						<div class="col-sm-9">
							<div class="view-field associated">
								<?= $tracking->has('version') ? $this->Html->link($tracking->version->name, ['controller' => 'Versions', 'action' => 'view', $tracking->version->id], ['escape' => false, 'class' => 'btn btn-sm btn-default']) : '&nbsp;' ?>
							</div>
						</div>
					</div>
					...
					<div class="form-group row"><!-- 4. -->
						...
						<div class="col-sm-9">
							<div class="view-field number">
								<?php
									if(!empty($tracking->old_id)){
										echo $this->Number->format($tracking->old_id);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 4. -->
						...
						<div class="col-sm-9">
							<div class="view-field number">
								<?php
									if(!empty($tracking->new_id)){
										echo $this->Number->format($tracking->new_id);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 5. -->
						...
						<div class="col-sm-9">
							<div class="view-field date">
								<?php
									if(!empty($tracking->created)){
										echo h($tracking->created);
									}else{
										echo "&nbsp;";
									}
								?>
