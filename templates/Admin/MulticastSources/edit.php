...
<?php //$format = $formats[$locale]; ?>
		<div class="edit col-sm-10">
			<div class="card card-lightblue">
				...
				<!-- form start -->
				<?= $this->Form->create($multicastSource, ['id' => 'main-form', 'class'=>'form-horizontal']) ?>
					...
					<div class="card-body" style="opacity: 0;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<?= $this->Form->control('src_ip', ['placeholder' => __(''), 'type'=>'text', 'class'=>'form-control', 'label' => false, 'autofocus' => false, "required" => false]) ?>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<?= $this->Form->control('dest_ip', ['placeholder' => __(''), 'type'=>'text', 'class'=>'form-control', 'label' => false, 'autofocus' => false, "required" => false]) ?>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<?= $this->Form->control('port', ['placeholder' => __(''), 'type'=>'text', 'class'=>'form-control', 'label' => false, 'autofocus' => false, "required" => false]) ?>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<?= $this->Form->control('interface', ['placeholder' => __(''), 'type'=>'text', 'class'=>'form-control', 'label' => false, 'autofocus' => false, "required" => false]) ?>
							</div>
						</div>
...
<?php if(isset($config['form_show_counts']) && $config['form_show_counts']){ ?>
						...
						<div class="form-group row">
							...
							<div class="input-group col-xs-12 col-sm-10 col-md-8 col-lg-4 col-xl-4">
								<div class="count"><?= $multicastSource->packages_programs_digital_count ?></div>
							</div>
						</div>
<?php } ?>
