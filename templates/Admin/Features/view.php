...
?>
		<div class="view col-sm-10 features">
			<div class="card card-lightblue">
				<div class="card-header">
					<h3 class="card-title"><?= $title ?>: <?= h($feature->name) ?></h3>
				</div><!-- /.card-header -->
				<div class="card-body">
					...
					<div class="form-group row"><!-- 4. -->
						...
						<div class="col-sm-9">
							<div class="view-field number">
								<?php
									if(!empty($feature->program_count)){
										echo $this->Number->format($feature->program_count);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 4. -->
						...
						<div class="col-sm-9">
							<div class="view-field number">
								<?php
									if(!empty($feature->pos)){
										echo $this->Number->format($feature->pos);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 5. -->
						...
						<div class="col-sm-9">
							<div class="view-field date">
								<?php
									if(!empty($feature->created)){
										echo h($feature->created);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 5. -->
						...
						<div class="col-sm-9">
							<div class="view-field date">
								<?php
									if(!empty($feature->modified)){
										echo h($feature->modified);
									}else{
										echo "&nbsp;";
									}
								?>
...
<?php } ?>
									...
									<tbody>
										<?php foreach ($feature->programs as $programs) : ?>
										<tr aria-expanded="true">
											<td class="name">
												<b><?= h($programs->name) ?></b>
												&nbsp;&nbsp;•&nbsp;<?php
													foreach($programs->packages_programs_digitals as $program){
														echo $program->package->popular_name . '; ';
													}
												?>
											</td>
