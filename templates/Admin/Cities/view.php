					...
					<div class="form-group row"><!-- 1. -->
						...
						<div class="col-sm-9">
							<div class="view-field associated">
								<?= $city->has('headstation') ? $this->Html->link($city->headstation->name, ['controller' => 'Headstations', 'action' => 'view', $city->headstation->id], ['escape' => false, 'class' => 'btn btn-sm btn-default']) : '' ?>
							</div>
						</div>
					</div>
					...
					<div class="form-group row"><!-- 4. -->
						...
						<div class="col-sm-9">
							<div class="view-field number">
								<?php
									if(!empty($city->pos)){
										echo $this->Number->format($city->pos);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 7. -->
						...
						<div class="col-sm-9">
							<div class="view-field text show-more">
								<?php // $this->Text->autoParagraph(h($city->comment)); ?>
								<?php
									if(!empty($city->comment)){
										//echo $this->Text->autoParagraph($city->comment) . "<br>";
										echo $city->comment . "<br>";
									}else{
										echo "&nbsp;";
									}
								?>
