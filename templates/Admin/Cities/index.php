...
<?php } ?>
								<td class="headstation-id integer link text-left" value="<?= $city->headstation_id ?>"><?= $city->has('headstation') ? $this->Html->link($city->headstation->name, ['controller' => 'Headstations', 'action' => 'view', $city->headstation->id]) : '' ?></td><!-- bake-1 -->
