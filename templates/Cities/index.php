...
<?php } ?>
								...
								<th class="name string"><?= __('Actions') ?></th>
...
<?php } ?>
								<td class="name string" name="name" style="width: 250px; font-size: 24px; font-weight: bold;" value="<?= $city->name ?>"><?= h($city->name) ?></td><!-- bake-2 -->
								<td class="name string export">
								
									<?= $this->Html->link('<span class="btn-label"><i class="icon-file-pdf"></i></span>' . __('PDF'), ['action' => 'digitals', 'pdf', $city->id], ['class'=>'btn btn-danger', 'role'=>'button', 'escape'=>false,  'data-bs-tooltip' => 'tooltip', 'data-bs-placement' => 'bottom', 'title'=>__('Generate PDF file')]) ?>
									&nbsp;&nbsp;&nbsp;
									<?= $this->Html->link('<span class="btn-label"><i class="icon-html5"></i></span>' . __('HTML'), ['action' => 'digitals', 'html', $city->id], ['class'=>'btn btn-warning', 'role'=>'button', 'escape'=>false,  'data-bs-tooltip' => 'tooltip', 'data-bs-placement' => 'bottom', 'title'=>__('Generate HTML')]) ?>

								</td><!-- bake-2 -->
<?php if(isset($config['index_show_visible']) && $config['index_show_visible']){ ?>
								<td class="visible boolean" name="visible" value="<?= $city->visible ?>"><?= h($city->visible) ?></td><!-- bake-2 -->
<?php } ?><?php if(isset($config['index_show_pos']) && $config['index_show_pos']){ ?>
								<td class="pos integer" name="pos" value="<?= $this->Number->format($city->pos) ?>"><?= $this->Number->format($city->pos) ?></td><!-- bake-3 -->
<?php } ?>
